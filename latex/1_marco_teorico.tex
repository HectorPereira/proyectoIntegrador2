...
\begin{figure}[H]
  ...
  \caption{Modelo con actuadores lineales Fuente: (https://grabcad.com/library/6dof-robot-arm-1)}\label{fig:insp.actuadores}
\end{figure}
...
\begin{figure}[H]
  ...
  \caption{Modelo hibrido/hidráulico (Fuente: https://grabcad.com/library/robotic-arm-216)}\label{fig:insp.oruga}
\end{figure}
...
\begin{figure}[H]
  ...
  \caption{Manipulador por garra y servomoto (Fuente: https://grabcad.com/library/robotic-gripper-17)}\label{fig:insp.orugaGarra}
\end{figure}
...
\begin{figure}[H]
  ...
  \caption{Sistema de eslabones (Fuente: https://grabcad.com/library/sea-reach-a-scalable-deep-sea-robotic-arm-1)}\label{fig:insp.eslabones}
\end{figure}
...
\begin{figure}[H]
  ...
  \caption{Sistema de eslabones con mayor libertad (Fuente: https://www.youtube.com/watch?v=EnAk36jC7bw)}\label{fig:insp.eslabones2}
\end{figure}
...
\begin{figure}[H]
  ...
  \caption{Modelo en mdf (Fuente: https://www.youtube.com/watch?v=4o_VI7fw6D8)}\label{fig:insp.mdf}
\end{figure}
...
\begin{figure}[H]
  ...
  \caption{Modelo similar en plástico (Fuente: `https://www.mercadolibre.com.uy/kit-robot-brazo--arduino-con-garra-electronica-manual-x-pc/up/MLUU2434320873#polycard_client=search-nordic&search_layout=stack&position=2&type=product&tracking_id=5621c8d5-293c-49de-ae85-3478bbfff815&wid=MLU455624003&sid=search')}\label{fig:insp.plastico}
\end{figure}
