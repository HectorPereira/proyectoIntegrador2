...
\subsubsection{Control de servomotores mediante modulación por ancho de pulso (PWM)}
...
\subsubsection{Conversión analógico-digital en microcontroladores}
...
\subsubsection{Comunicación serial UART en sistemas embebidos}
...
\subsubsection{Interfaz humano-máquina (HMI) en robótica}
...
\subsubsection{Máquinas de estado finito en sistemas embebidos}
...
\subsubsection{Antirrebote en lectura de botones}
...
\subsubsection{Control de actuadores digitales simples}
...
\subsubsection{Seguridad funcional en sistemas robóticos}
...
\subsubsection{Temporización y control en tiempo real}
...
\subsubsection{Interfaces gráficas de usuario en robótica}
...
\subsubsection{Arquitecturas de comunicación en sistemas robóticos}
...
\subsubsection{Modos de operación en manipuladores robóticos}
...
\subsubsection{Grabación y reproducción de trayectorias}
...
\subsubsection{Seguridad en interfaces de control robótico}
