...
\begin{figure}[H]
  ...
  \caption{Diseño con eslabones y servomotores mg996r (Fuente: elaboración propia)}\label{fig:insp.eslabones.propio}
\end{figure}
...
\subsection{Diseños CAD}\label{ap:disenos_CAD}
