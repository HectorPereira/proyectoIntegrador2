...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{../anexos/inspiraciones/11diseñoEslabones.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{../anexos/Articulacion/V2.png}
  \caption{Sistema de articulación desmontable. Fuente: elaboración própia}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{../anexos/Articulacion/Perno V2.png}
  \caption{Corte transversal perno --- versión original. Fuente: elaboración própia}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{../anexos/Pruebas/Prueba articulacion.jpg}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{../anexos/Articulacion/Perno V3.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{../anexos/Torno/Plano.jpg}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.9\textwidth]{../anexos/Controlador Espejo/Notas controlador.jpg}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.9\textwidth]{../anexos/software/Pruebas de integración.png}
...
\subsection{Código}\label{apendice:codigo}
...
void servo1_set(uint8_t angle){ 
  OCR1A = (SERVO_MIN_US + angle*(SERVO_MAX_US-SERVO_MIN_US)/180)*2; 
}
void servo2_set(uint8_t angle){ 
  OCR1B = (SERVO_MIN_US + angle*(SERVO_MAX_US-SERVO_MIN_US)/180)*2; 
  }
...
void servo3_set(uint8_t angle){ 
  OCR2A = ((SERVO_MIN_US + angle*(SERVO_MAX_US-SERVO_MIN_US)/180)*2)/8; 
}
void servo4_set(uint8_t angle){ 
  OCR2B = ((SERVO_MIN_US + angle*(SERVO_MAX_US-SERVO_MIN_US)/180)*2)/8; 
}
