...
\begin{figure}[H]
  ...
  \caption{Esquema de procedimiento y tareas seguido durante el proyecto. Fuente: elaboración propia}\label{fig:diagrama_gantt}
\end{figure}
...
\begin{figure}[H]
  ...
  \caption{Galgas para medición de tolerancias. Fuente: elaboración propia}\label{fig:galgas}
\end{figure}
